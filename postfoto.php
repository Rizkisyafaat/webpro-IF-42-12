...
function postfoto($data) {
    ...
    $jenisfile = array('png', 'jpg', 'jpeg', 'svg');
    ...
    $file_tmp = $_FILES['url']['tmp_name'];
        ...
        if (in_array($ekstensi, $jenisfile) === true) 
        {
            ...
            {
                echo '<script>fie melewati batas</script>';
            }
        } 
        else 
        {
            echo '<script>format foto salah</script>';
    }
}
...
if (isset($_POST["submit"])) 
{
    if (!postfoto($_POST) > 0) 
    {
        echo 
        "<script>
            alert('foto berhasil di posting');
...
<head>
    ...
    <title>Posting foto | Vietgram</title>
